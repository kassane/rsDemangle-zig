...
pub export fn rust_demangle_callback(arg_mangled: [*c]const u8, arg_options: c_int, arg_callback: demangle_callbackref, arg_opaque: ?*anyopaque) c_int {
    ...
    if (rdm.version == -@as(c_int, 1)) {
        ...
        rdm.sym_len -%= 1;
        if (!((rdm.sym_len > @bitCast(c_ulong, @as(c_long, @as(c_int, 19)))) and !(clib.memcmp(@ptrCast(?*const anyopaque, &rdm.sym[rdm.sym_len -% @bitCast(c_ulong, @as(c_long, @as(c_int, 19)))]), @ptrCast(?*const anyopaque, "17h"), @bitCast(c_ulong, @as(c_long, @as(c_int, 3)))) != 0))) return 0;
        while (true) {
...
pub export fn rust_demangle(arg_mangled: [*c]const u8, arg_options: c_int) [*c]u8 {
    ...
    if (!(success != 0)) {
        clib.free(@ptrCast(?*anyopaque, out.ptr));
        return null;
    }
    str_buf_append(&out, "\x00", @bitCast(usize, @as(c_long, @as(c_int, 1))));
    return out.ptr;
}
pub fn peek(arg_rdm: [*]const rust_demangler) callconv(.C) u8 {
    var rdm = arg_rdm;
    if (rdm.*.next < rdm.*.sym_len) return rdm.*.sym[rdm.*.next];
    return 0;
}
pub fn eat(arg_rdm: [*]rust_demangler, arg_c: u8) callconv(.C) c_int {
    var rdm = arg_rdm;
    var c = arg_c;
...
pub fn next(arg_rdm: [*]rust_demangler) callconv(.C) u8 {
    var rdm = arg_rdm;
    var c: u8 = peek(rdm);
    if (!(c != 0)) {
        rdm.*.errored = 1;
...
pub fn parse_integer_62(arg_rdm: [*]rust_demangler) callconv(.C) u64 {
    var rdm = arg_rdm;
    var c: u8 = undefined;
    var x: u64 = undefined;
...
pub fn parse_opt_integer_62(arg_rdm: [*]rust_demangler, arg_tag: u8) callconv(.C) u64 {
    var rdm = arg_rdm;
    var tag = arg_tag;
    if (!(eat(rdm, tag) != 0)) return 0;
    return @bitCast(c_ulong, @as(c_long, @as(c_int, 1))) +% parse_integer_62(rdm);
}
pub fn parse_disambiguator(arg_rdm: [*]rust_demangler) callconv(.C) u64 {
    var rdm = arg_rdm;
    return parse_opt_integer_62(rdm, @bitCast(u8, @truncate(i8, @as(c_int, 's'))));
}
pub fn parse_ident(arg_rdm: [*]rust_demangler) callconv(.C) rust_mangled_ident {
    var rdm = arg_rdm;
    var c: u8 = undefined;
...
pub fn print_str(arg_rdm: [*]rust_demangler, arg_data: [*c]const u8, arg_len: usize) callconv(.C) void {
    var rdm = arg_rdm;
    var data = arg_data;
    var len = arg_len;
...
pub fn print_uint64(arg_rdm: [*]rust_demangler, arg_x: u64) callconv(.C) void {
    var rdm = arg_rdm;
    var x = arg_x;
    var s: [21]u8 = undefined;
    _ = clib.sprintf(@ptrCast([*]u8, @alignCast(@import("std").meta.alignment(u8), &s)), "%lu", x);
    print_str(rdm, @ptrCast([*]u8, @alignCast(@import("std").meta.alignment(u8), &s)), clib.strlen(@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment(u8), &s))));
}
pub fn print_uint64_hex(arg_rdm: [*]rust_demangler, arg_x: u64) callconv(.C) void {
    var rdm = arg_rdm;
    var x = arg_x;
    var s: [17]u8 = undefined;
    _ = clib.sprintf(@ptrCast([*]u8, @alignCast(@import("std").meta.alignment(u8), &s)), "%lx", x);
    print_str(rdm, @ptrCast([*]u8, @alignCast(@import("std").meta.alignment(u8), &s)), clib.strlen(@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment(u8), &s))));
}
...
pub fn decode_legacy_escape(arg_e: [*c]const u8, arg_len: usize, arg_out_len: [*c]usize) callconv(.C) u8 {
    ...
    return c;
} // rust-demangle.c:469:13: warning: TODO implement translation of stmt class GotoStmtClass
// rust-demangle.c:332:1: warning: unable to translate function, demoted to extern
pub extern fn print_ident(arg_rdm: [*]rust_demangler, arg_ident: rust_mangled_ident) callconv(.C) void;
pub fn print_lifetime_from_index(arg_rdm: [*]rust_demangler, arg_lt: u64) callconv(.C) void {
    var rdm = arg_rdm;
    var lt = arg_lt;
    var c: u8 = undefined;
    var depth: u64 = undefined;
    print_str(rdm, "'", clib.strlen("'"));
    if (lt == @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))) {
        print_str(rdm, "_", clib.strlen("_"));
        return;
    }
...
pub fn demangle_binder(arg_rdm: [*]rust_demangler) callconv(.C) void {
    var rdm = arg_rdm;
    var i: u64 = undefined;
    ...
    if (bound_lifetimes > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))) {
        print_str(rdm, "for<", clib.strlen("for<"));
        {
            i = 0;
...
pub fn demangle_path(arg_rdm: [*]rust_demangler, arg_in_value: c_int) callconv(.C) void {
    var rdm = arg_rdm;
        ...
        switch (@bitCast(c_int, @as(c_uint, blk: {
                ...
                if ((@bitCast(c_int, @as(c_uint, ns)) >= @as(c_int, 'A')) and (@bitCast(c_int, @as(c_uint, ns)) <= @as(c_int, 'Z'))) {
                    ...
                    while (true) {
                        switch (@bitCast(c_int, @as(c_uint, ns))) {
                            @as(c_int, 67) => {
                                print_str(rdm, "closure", clib.strlen("closure"));
                                break;
                            },
                            @as(c_int, 83) => {
                                print_str(rdm, "shim", clib.strlen("shim"));
                                break;
                            },
                            else => {
            ...
            @as(c_int, 77), @as(c_int, 88) => {
                ...
                if (@bitCast(c_int, @as(c_uint, tag)) != @as(c_int, 'M')) {
                    print_str(rdm, " as ", clib.strlen(" as "));
                    demangle_path(rdm, @as(c_int, 0));
                }
                print_str(rdm, ">", clib.strlen(">"));
                break;
...
pub fn demangle_generic_arg(arg_rdm: [*]rust_demangler) callconv(.C) void {
    var rdm = arg_rdm;
...
} // rust-demangle.c:902:19: warning: TODO implement translation of stmt class GotoStmtClass
// rust-demangle.c:812:1: warning: unable to translate function, demoted to extern
pub extern fn demangle_type(arg_rdm: [*]rust_demangler) callconv(.C) void;
pub fn demangle_path_maybe_open_generics(arg_rdm: [*]rust_demangler) callconv(.C) c_int {
    var rdm = arg_rdm;
...
pub fn demangle_dyn_trait(arg_rdm: [*]rust_demangler) callconv(.C) void {
    var rdm = arg_rdm;
    var open: c_int = undefined;
    var name: rust_mangled_ident = undefined;
    if (rdm.*.errored != 0) return;
...
pub fn demangle_const(arg_rdm: [*]rust_demangler) callconv(.C) void {
    var rdm = arg_rdm;
    ...
    if (rdm.*.verbose != 0) {
        print_str(rdm, ": ", clib.strlen(": "));
        print_str(rdm, basic_type(ty_tag), clib.strlen(basic_type(ty_tag)));
    }
}
pub fn demangle_const_uint(arg_rdm: [*]rust_demangler) callconv(.C) void {
    var rdm = arg_rdm;
    var c: u8 = undefined;
    ...
    if (hex_len > @bitCast(c_ulong, @as(c_long, @as(c_int, 16)))) {
        print_str(rdm, "0x", clib.strlen("0x"));
...
pub fn str_buf_reserve(arg_buf: [*]str_buf, arg_extra: usize) callconv(.C) void {
    var buf = arg_buf;
    var extra = arg_extra;
    ...
    new_ptr = @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment(u8), clib.realloc(@ptrCast(?*anyopaque, buf.*.ptr), new_cap)));
    if (new_ptr == @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment(u8), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
        clib.free(@ptrCast(?*anyopaque, buf.*.ptr));
        buf.*.ptr = null;
        buf.*.len = 0;
        buf.*.cap = 0;
        buf.*.errored = 1;
...
pub fn str_buf_append(arg_buf: [*]str_buf, arg_data: [*c]const u8, arg_len: usize) callconv(.C) void {
    var buf = arg_buf;
    var data = arg_data;
    var len = arg_len;
...
pub fn str_buf_demangle_callback(arg_data: [*c]const u8, arg_len: usize, arg_opaque: ?*anyopaque) callconv(.C) void {
    ...
    var len = arg_len;
    var @"opaque" = arg_opaque;
    str_buf_append(@ptrCast([*]str_buf, @alignCast(@import("std").meta.alignment(str_buf), @"opaque")), data, len);
}

pub inline fn ISDIGIT(c: anytype) @TypeOf((c >= '0') and (c <= '9')) {
    return (c >= '0') and (c <= '9');
}
pub inline fn ISUPPER(c: anytype) @TypeOf((c >= 'A') and (c <= 'Z')) {
    return (c >= 'A') and (c <= 'Z');
}
pub inline fn ISLOWER(c: anytype) @TypeOf((c >= 'a') and (c <= 'z')) {
    return (c >= 'a') and (c <= 'z');
}
pub inline fn ISALNUM(c: anytype) @TypeOf(((ISDIGIT(c) != 0) or (ISLOWER(c) != 0)) or (ISUPPER(c) != 0)) {
    return ((ISDIGIT(c) != 0) or (ISLOWER(c) != 0)) or (ISUPPER(c) != 0);
}
pub const DMGL_VERBOSE = @as(c_int, 1) << @as(c_int, 3);
