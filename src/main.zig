...
test "demangled" {
    ...
    var demangled = mem.sliceTo(rust_demangle("_ZN11rust_mangle7sum_add17hf6faed35db54da66E", options), 0);
    ...
    demangled = mem.sliceTo(rust_demangle("_ZN11rust_mangle7sum_add17hf6faed35db54da66E", options), 0);
    ...
    demangled = mem.sliceTo(rust_demangle("_RNCINkXs25_NgCsbmNqQUJIY6D_4core5sliceINyB9_4IterhENuNgNoBb_4iter8iterator8Iterator9rpositionNCNgNpB9_6memchr7memrchrs_0E0Bb_", options), 0);
    ...
    demangled = mem.sliceTo(rust_demangle("_RINbNbCskIICzLVDPPb_5alloc5alloc8box_freeDINbNiB4_5boxed5FnBoxuEp6OutputuEL_ECs1iopQbuBiw2_3std", options), 0);
